...
/**
 Base class for all PROJETO_IGARASSU views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the PROJETO_IGARASSU view hierarchy (such as wrapped iOS UIViews) was touched.
