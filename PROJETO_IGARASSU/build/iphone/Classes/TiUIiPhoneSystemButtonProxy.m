...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ACTIVITY,UIPROJETO_IGARASSUNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.ACTIVITY",@"5.4.0",@"UI.iOS.SystemButtonStyle.ACTIVITY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(SPINNER,UIPROJETO_IGARASSUNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.SPINNER",@"5.4.0",@"UI.iOS.SystemButtonStyle.SPINNER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_LIGHT,UIPROJETO_IGARASSUNativeItemInfoLight,@"UI.iPhone.SystemButtonStyle.INFO_LIGHT",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_DARK,UIPROJETO_IGARASSUNativeItemInfoDark,@"UI.iPhone.SystemButtonStyle.INFO_DARK",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_DARK");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(DISCLOSURE,UIPROJETO_IGARASSUNativeItemDisclosure,@"UI.iPhone.SystemButtonStyle.DISCLOSURE",@"5.4.0",@"UI.iOS.SystemButtonStyle.DISCLOSURE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(CONTACT_ADD,UIPROJETO_IGARASSUNativeItemContactAdd,@"UI.iPhone.SystemButtonStyle.CONTACT_ADD",@"5.4.0",@"UI.iOS.SystemButtonStyle.CONTACT_ADD");
